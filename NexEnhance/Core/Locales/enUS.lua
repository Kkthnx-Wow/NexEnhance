...
L["Cursor"] = "Cursor"
L["DESC_CURSOR"] = "Mouse cursor extras — GCD ring under the pointer, soft motion trail, and related options."
L["DESC_UNITFRAMES"] = "Adjustments to the default player, target, focus and group frames, like class-coloured health."
L["Nameplates"] = "Nameplates"
L["DESC_NAMEPLATES"] = "Additions to enemy and NPC nameplates, like quest objective icons."
L["Camera"] = "Camera"
L["DESC_CAMERA"] = "Camera behaviour, like extended max zoom and the idle AFK pan."
L["Alerts"] = "Alerts"
L["DESC_ALERTS"] = "On-screen alert and notification widgets, like loot rolls and queue pops."
L["Movers"] = "Movers"
L["DESC_MOVERS"] = "Reposition default and addon frames, including the draggable-frame and widget movers."
...
L["DESC_PLUGINS"] = "Extensions built by other authors as separate addons. Each plugin gets its own enable toggle and settings here; use Plugin Manager for a quick overview of everything installed."
...
L["Unknown"] = "Unknown"
L["Unknown module '%s'."] = "Unknown module '%s'."
L["PLUGIN_NONE_INSTALLED"] = "No plugins installed. See Plugin Manager in Settings for setup steps."
L["PLUGIN_INSTALL_HINT"] = "To add a plugin, install a separate addon folder that lists NexEnhance as a dependency and calls NexEnhance:RegisterPlugin(...) on load. Duplicate Examples/NexEnhancePluginTemplate/ in this addon's folder to get started, then /reload."
L["PLUGIN_BY_AUTHOR"] = "By %s · v%s"
L["PLUGIN_ADDON_FOLDER"] = "Addon folder: %s"
L["PLUGIN_RELOAD_FOR_OPTIONS"] = "New plugin registered — reload UI (/reload) for its settings to appear in the panel."
L["PLUGIN_OPEN_SETTINGS_HINT"] = "Open Esc → Options → NexEnhance → Plugins for settings, or Plugin Manager for an overview."
L["List installed NexEnhance plugins"] = "List installed NexEnhance plugins"
...
L["Menu Buttons"] = "Menu Buttons"
L["Add quick Add Friend, Guild Invite, Copy Name and Whisper actions to the unit right-click menu."] = "Add quick Add Friend, Guild Invite, Copy Name and Whisper actions to the unit right-click menu."
...
L["Hide guild rank text on player tooltips (rank index still shown)."] = "Hide guild rank text on player tooltips (rank index still shown)."
L["Hide Unit Tooltips in Combat"] = "Hide Unit Tooltips in Combat"
L["Hide unit tooltips while in combat (hold Shift to reveal)."] = "Hide unit tooltips while in combat (hold Shift to reveal)."
L["Show Crafting Reagents"] = "Show Crafting Reagents"
L["On craftable items, show required reagents with your bag and bank counts."] = "On craftable items, show required reagents with your bag and bank counts."
L["Crafting Reagents"] = "Crafting Reagents"
L["Can Create Multiple Item Format"] = "You can craft %d of these with your materials."
L["Tooltip Pawn Integration Note"] = "Pawn is installed. While Show Icons is enabled, Pawn's corner tooltip icons are suppressed. While Quality-Coloured Border is enabled, Pawn's green upgrade border is suppressed — Pawn upgrade percentages and scores still appear in the tooltip text."
L["Tooltip Pawn Icons Override"] = "Also disables Pawn's separate corner tooltip icons while this is on."
L["Tooltip Pawn Border Override"] = "Also disables Pawn's green upgrade border while this is on."
...
L["Print addon and WoW client version info"] = "Print addon and WoW client version info"
...
L["Settings will open when you leave combat."] = "Settings will open when you leave combat."
L["Edit Mode will open when you leave combat."] = "Edit Mode will open when you leave combat."
...
L["Double-click Group Finder results to apply, auto-invite applicants, hide throwaway LFG popups, and show leader rating and region tags."] = "Double-click Group Finder results to apply, auto-invite applicants, hide throwaway LFG popups, and show leader rating and region tags."
...
L["Show Leader Region"] = "Show Leader Region"
L["Show a locale region tag (e.g. MX, OCE, DE) on Group Finder results when the leader is on a different realm locale than yours."] = "Show a locale region tag (e.g. MX, OCE, DE) on Group Finder results when the leader is on a different realm locale than yours."
L["Leader region: %s"] = "Leader region: %s"
L["Leader region: %s (%s)"] = "Leader region: %s (%s)"
...
-- Auto Role
L["Auto Role"] = "Auto Role"
L["Enable Auto Role"] = "Enable Auto Role"
L["Automatically set your party role to match your specialization when you join a group or change talents. Skips LFG dungeon groups and scenarios."] = "Automatically set your party role to match your specialization when you join a group or change talents. Skips LFG dungeon groups and scenarios."
L["Answer Role Polls"] = "Answer Role Polls"
L["When the group leader starts a role poll, set your role immediately and skip Blizzard's popup."] = "When the group leader starts a role poll, set your role immediately and skip Blizzard's popup."
...
L["Equipped Item Border"] = "Equipped Item Border"
L["Replace Blizzard's faint equipped-item border with a brighter green border that matches the action-bar frame."] = "Replace Blizzard's faint equipped-item border with a brighter green border that matches the action-bar frame."
...
L["Extra Quest Button"] = "Extra Quest Button"
L["Show a keybindable button for the closest usable quest item (reload to fully hide)."] = "Show a keybindable button for the closest usable quest item (reload to fully hide)."
L["Button Size"] = "Button Size"
L["Size of the Extra Quest Button, in pixels (applied out of combat)."] = "Size of the Extra Quest Button, in pixels (applied out of combat)."
L["Only Tracked Quests"] = "Only Tracked Quests"
L["Only consider watched quests, world quests, and bonus objectives."] = "Only consider watched quests, world quests, and bonus objectives."
L["Only Current Zone"] = "Only Current Zone"
L["Only show quest items for quests in your current zone."] = "Only show quest items for quests in your current zone."
L["Tracking Distance"] = "Tracking Distance"
L["Maximum quest distance, in yards."] = "Maximum quest distance, in yards."
...
L["Show a class-coloured cooldown ring under your cursor during the Global Cooldown (and optionally while casting)."] = "Show a class-coloured cooldown ring under your cursor during the Global Cooldown (and optionally while casting)."
L["Show Cast Ring"] = "Show Cast Ring"
L["Also show an inner ring while you cast or channel."] = "Also show an inner ring while you cast or channel."
L["Combat Only"] = "Combat Only"
L["Only show the cursor ring while you are in combat."] = "Only show the cursor ring while you are in combat."
L["Cursor Ring Size"] = "Cursor Ring Size"
L["Diameter of the cursor ring in pixels."] = "Diameter of the cursor ring in pixels."

-- Cursor Trail
L["Cursor Trail"] = "Cursor Trail"
L["Enable Cursor Trail"] = "Enable Cursor Trail"
L["Show a soft glowing trail that follows your mouse cursor. Lightweight pooled dots; sleeps when idle."] = "Show a soft glowing trail that follows your mouse cursor. Lightweight pooled dots; sleeps when idle."
L["Only draw the cursor trail while you are in combat."] = "Only draw the cursor trail while you are in combat."
L["Hide While Turning"] = "Hide While Turning"
L["Hide the trail while you turn or look with the mouse (mouselook)."] = "Hide the trail while you turn or look with the mouse (mouselook)."
L["Trail Color Mode"] = "Trail Color Mode"
L["Class colour, a custom colour, or a rainbow flow along the trail."] = "Class colour, a custom colour, or a rainbow flow along the trail."
L["Class Color"] = "Class Color"
L["Custom Color"] = "Custom Color"
L["Rainbow"] = "Rainbow"
L["Trail Color"] = "Trail Color"
L["Used when Trail Color Mode is Custom Color."] = "Used when Trail Color Mode is Custom Color."
L["Trail Dot Size"] = "Trail Dot Size"
L["Diameter of each trail dot in pixels."] = "Diameter of each trail dot in pixels."
L["Trail Spacing"] = "Trail Spacing"
L["Minimum pixels the cursor must move before a new dot is placed."] = "Minimum pixels the cursor must move before a new dot is placed."
L["Trail Lifetime"] = "Trail Lifetime"
L["How long each dot lasts, in seconds."] = "How long each dot lasts, in seconds."
L["Max Trail Dots"] = "Max Trail Dots"
L["Maximum dots in the pool. Higher looks denser but costs more GPU."] = "Maximum dots in the pool. Higher looks denser but costs more GPU."
L["Trail Opacity"] = "Trail Opacity"
L["Peak opacity of the newest trail dots."] = "Peak opacity of the newest trail dots."
L["Shrink Over Time"] = "Shrink Over Time"
L["Dots get smaller as they fade out."] = "Dots get smaller as they fade out."
L["Horizontal offset from the cursor tip, in pixels."] = "Horizontal offset from the cursor tip, in pixels."
L["Vertical offset from the cursor tip, in pixels."] = "Vertical offset from the cursor tip, in pixels."
...
-- UnitFrameText
L["Unit Frame Text"] = "Unit Frame Text"
L["Enable Unit Frame Text"] = "Enable Unit Frame Text"
L["Cosmetic tweaks for Blizzard unit frame name and level text."] = "Cosmetic tweaks for Blizzard unit frame name and level text."
L["White Name and Level"] = "White Name and Level"
L["Show unit names in white instead of the default gold on player, target, focus, boss, pet, target-of-target, and standard party portraits. Player level goes white too. Target level keeps Level Colours difficulty tints, but the default yellow band becomes white instead. Compact raid/party frames are unchanged."] = "Show unit names in white instead of the default gold on player, target, focus, boss, pet, target-of-target, and standard party portraits. Player level goes white too. Target level keeps Level Colours difficulty tints, but the default yellow band becomes white instead. Compact raid/party frames are unchanged."
...
L["Best Quest Reward"] = "Best Quest Reward"
L["Enable Best Quest Reward"] = "Enable Best Quest Reward"
L["Mark the highest vendor-value quest reward choice with a gold coin. Does not auto-pick — use Quick Quest for that."] = "Mark the highest vendor-value quest reward choice with a gold coin. Does not auto-pick — use Quick Quest for that."
...
L["Hide the collapse/expand arrow that sits next to your buffs."] = "Hide the collapse/expand arrow that sits next to your buffs."
L["Hide Micro Menu & Bags"] = "Hide Micro Menu & Bags"
L["Hide the micro-menu buttons and the bag bar in the bottom-right (open them with keybinds). Reload to fully restore."] = "Hide the micro-menu buttons and the bag bar in the bottom-right (open them with keybinds). Reload to fully restore."
L["Hide Portrait Damage Text"] = "Hide Portrait Damage Text"
...
L["Width"] = "Width"
L["Width of each loot roll bar."] = "Width of each loot roll bar."
L["Height"] = "Height"
L["Height of each loot roll bar."] = "Height of each loot roll bar."
L["Can't Roll"] = "Can't Roll"
L["Toggle loot roll test bars"] = "Toggle loot roll test bars"
L["Toggle quest notification self-test"] = "Toggle quest notification self-test"
L["Test bars shown - click a button or wait to dismiss."] = "Test bars shown - click a button or wait to dismiss."
L["Test bars hidden."] = "Test bars hidden."
...
L["Hide messages matching blacklisted keywords or repeated near-identical spam."] = "Hide messages matching blacklisted keywords or repeated near-identical spam."
L["CHATFILTER_KEYWORDS_TIP"] = "One keyword per line. A message is hidden once it matches your match threshold. Changes apply when you click away from the box. You can still use /nexfilter for quick adds."
L["CHATFILTER_WHITELIST_TIP"] = "Channel whitelist only: trade/service lines on /2 must match at least one of these keywords or they are hidden. One keyword per line; changes apply when you click away."
L["Restore Default Keywords"] = "Restore Default Keywords"
...
L["Chat filter default keywords restored."] = "Chat filter default keywords restored."
...
L["%d buttons in tray"] = "%d buttons in tray"
L["Calendar"] = "Calendar"
...
L["Achievement Back Button"] = "Achievement Back Button"
L["Add a back button to the Achievements frame that retraces your category and achievement history."] = "Add a back button to the Achievements frame that retraces your category and achievement history."
...
L["Quest Notification debug WQ on"] = "Announce World Quests: on"
L["Quest Notification debug WQ off"] = "Announce World Quests: off"
L["Quest Notification debug suppressed WQs"] = "World quests suppressed (%d):"
L["Quest Notification debug eligible"] = "Eligible incomplete quests: %d"
L["Quest Notification debug live hint"] = "Make quest progress to see live messages here."
L["Accepted"] = "Accepted:"
L["Accepted (%d):"] = "Accepted (%d):"
L["Completed (%d):"] = "Completed (%d):"
L["and %d more"] = "and %d more"
L["Batch Announcements"] = "Batch Announcements"
L["Combine multiple accepts or completions from the same moment into one chat line."] = "Combine multiple accepts or completions from the same moment into one chat line."
L["Announce World Quests"] = "Announce World Quests"
L["Include world quest accepts, progress, and completions in group chat."] = "Include world quest accepts, progress, and completions in group chat."
...
-- PullCountdown
L["Pull Countdown"] = "Pull Countdown"
L["Enable Pull Countdown"] = "Enable Pull Countdown"
L["Announce a pull timer in party/raid chat with /pc [seconds]. Second /pc cancels. Requires a group and out of combat."] = "Announce a pull timer in party/raid chat with /pc [seconds]. Second /pc cancels. Requires a group and out of combat."
L["Default Pull Seconds"] = "Default Pull Seconds"
L["Seconds used when you type /pc with no number."] = "Seconds used when you type /pc with no number."
L["Pull Countdown is disabled."] = "Pull Countdown is disabled."
L["You must be in a group to start a pull countdown."] = "You must be in a group to start a pull countdown."
L["You can't start a pull countdown in combat."] = "You can't start a pull countdown in combat."
L["Pull ABORTED!"] = "Pull ABORTED!"
L["Pulling %s in %d.."] = "Pulling %s in %d.."
L["Pulling in %d.."] = "Pulling in %d.."
L["Pull!"] = "Pull!"
...
L["Cannot preview AFK mode during combat."] = "Cannot preview AFK mode during combat."
...
L["Right-click to announce"] = "Right-click to announce"
L["Right-Click To Announce"] = "Right-Click To Announce"
L["Right-click the popup to share the rare and a map-pin link in chat - your group when grouped, otherwise General chat."] = "Right-click the popup to share the rare and a map-pin link in chat - your group when grouped, otherwise General chat."
L["No location to announce yet."] = "No location to announce yet."
L["Wait %d seconds before announcing again."] = "Wait %d seconds before announcing again."
L["No chat channel available to announce."] = "No chat channel available to announce."
L["Someone already announced this rare in chat."] = "Someone already announced this rare in chat."
...
L["Upcoming Invasions"] = "Upcoming Invasions"
L["Hold SHIFT for info"] = "Hold SHIFT for more event info."
L["Hold SHIFT for all lockouts"] = "Hold SHIFT to show all lockouts."
...
L["Guild"] = "Guild"
L["Enable Guild Text"] = "Enable Guild Text"
L["Show online guild member count on the Guild micro button with a roster tooltip (reload to disable)."] = "Show online guild member count on the Guild micro button with a roster tooltip (reload to disable)."
L["Max Members"] = "Max Members"
L["Maximum members shown in the guild tooltip before collapsing the rest."] = "Maximum members shown in the guild tooltip before collapsing the rest."
L["Show MOTD"] = "Show MOTD"
L["Show the guild message of the day in the tooltip."] = "Show the guild message of the day in the tooltip."
L["Hold Shift for rank and notes"] = "Hold Shift for rank and notes"

L["Friends"] = "Friends"
L["Enable Friends Text"] = "Enable Friends Text"
L["Show a friends roster tooltip when hovering the social button by the chat frame (reload to disable)."] = "Show a friends roster tooltip when hovering the social button by the chat frame (reload to disable)."
L["Max Friends"] = "Max Friends"
L["Maximum friends shown in the tooltip before stopping."] = "Maximum friends shown in the tooltip before stopping."
L["Friends List"] = "Friends List"
L["Hold Shift for details"] = "Hold Shift for details"

L["Currency & Gold"] = "Currency & Gold"
L["Enable Currency & Gold"] = "Enable Currency & Gold"
L["Show a wealth tooltip (gold, Warband, currencies) when hovering the character micro button (reload to disable)."] = "Show a wealth tooltip (gold, Warband, currencies) when hovering the character micro button (reload to disable)."
L["Max Characters"] = "Max Characters"
L["Maximum characters listed in the gold tooltip before collapsing the rest."] = "Maximum characters listed in the gold tooltip before collapsing the rest."
L["Session"] = "Session"
L["Earned"] = "Earned"
L["Spent"] = "Spent"
L["Profit"] = "Profit"
...
L["Auto Greed"] = "Auto Greed"
L["Enable Auto Greed"] = "Enable Auto Greed"
L["Automatically roll Greed (or Disenchant) on low-rarity group loot."] = "Automatically roll Greed (or Disenchant) on low-rarity group loot."
L["Max Level Only"] = "Max Level Only"
L["Only auto-roll while at the expansion's max level."] = "Only auto-roll while at the expansion's max level."
L["Prefer Disenchant"] = "Prefer Disenchant"
L["Disenchant instead of Greed whenever you are able to."] = "Disenchant instead of Greed whenever you are able to."
L["Include Rares"] = "Include Rares"
L["Also auto-roll on Rare (blue) items, not just Uncommon (green)."] = "Also auto-roll on Rare (blue) items, not just Uncommon (green)."
L["Skip Bind on Pickup"] = "Skip Bind on Pickup"
L["Never auto-roll on Bind-on-Pickup items; leave those for you to decide."] = "Never auto-roll on Bind-on-Pickup items; leave those for you to decide."
L["Auto-Confirm"] = "Auto-Confirm"
L["Automatically confirm the bind/soulbound popup for rolls this module made."] = "Automatically confirm the bind/soulbound popup for rolls this module made."
...
L["Current Profile for %s: %s"] = "Current profile for %s: %s"
L["PROFILE_CHAR_HINT"] = "Profiles are saved account-wide. Each character remembers which profile it uses — create one with New or Copy Current As, then Switch To."
...
L["Show a background behind the chat window."] = "Show a background behind the chat window."
L["None"] = "None"
L["Full Background"] = "Full Background"
L["Gradient"] = "Gradient"
...
L["Emoji Autocomplete"] = "Emoji Autocomplete"
L["Type : in chat to pick :name: emojis from a list. Tab, Enter, or click to insert."] = "Type : in chat to pick :name: emojis from a list. Tab, Enter, or click to insert."
...
L["Nameplate Quest Icons"] = "Nameplate Quest Icons"
L["Enable Nameplate Quest Icons"] = "Enable Nameplate Quest Icons"
L["Show a quest icon (and optional objective progress) on the nameplates of NPCs tied to your active quests."] = "Show a quest icon (and optional objective progress) on the nameplates of NPCs tied to your active quests."
L["Show Party Quests"] = "Show Party Quests"
L["Also mark NPCs that are only on a party member's quest (the icon is greyed)."] = "Also mark NPCs that are only on a party member's quest (the icon is greyed)."
L["Size of the quest icon, in pixels."] = "Size of the quest icon, in pixels."
L["Progress Text Size"] = "Progress Text Size"
L["Font size of the objective progress text next to the icon."] = "Font size of the objective progress text next to the icon."
L["Icon Side"] = "Icon Side"
L["Which side of the nameplate healthbar the icon sits on."] = "Which side of the nameplate healthbar the icon sits on."
L["Right of Healthbar"] = "Right of Healthbar"
L["Left of Healthbar"] = "Left of Healthbar"
L["Offset X"] = "Offset X"
L["Horizontal nudge for the icon."] = "Horizontal nudge for the icon."
L["Offset Y"] = "Offset Y"
L["Vertical nudge for the icon."] = "Vertical nudge for the icon."
L["Show Objective Progress"] = "Show Objective Progress"
L["When to show the objective count next to the icon."] = "When to show the objective count next to the icon."
L["Never"] = "Never"
...
L["Which key shows progress when 'While Holding a Key' is selected."] = "Which key shows progress when 'While Holding a Key' is selected."
L["Alt"] = "Alt"
L["Ctrl"] = "Ctrl"
L["Shift"] = "Shift"
L["Progress Format"] = "Progress Format"
L["Show how many objectives are completed, or how many remain."] = "Show how many objectives are completed, or how many remain."
L["Completed (3/7)"] = "Completed (3/7)"
L["Remaining (4)"] = "Remaining (4)"

-- Nameplate Target Arrows
L["Target Arrows"] = "Target Arrows"
L["Enable Target Arrows"] = "Enable Target Arrows"
L["Enable nameplate target arrows and friendly-player nameplate options."] = "Enable nameplate target arrows and friendly-player nameplate options."
L["Show Target Arrows"] = "Show Target Arrows"
L["Show arrow indicators on your current target's nameplate."] = "Show arrow indicators on your current target's nameplate."
L["Arrow Style"] = "Arrow Style"
L["Horizontal places arrows on both sides of the health bar; Top places a single Azerite arrow above the nameplate."] = "Horizontal places arrows on both sides of the health bar; Top places a single Azerite arrow above the nameplate."
L["Horizontal"] = "Horizontal"
L["Top (Azerite Arrow)"] = "Top (Azerite Arrow)"
L["Arrow Color"] = "Arrow Color"
L["Tint color for the target arrow textures."] = "Tint color for the target arrow textures."
L["Arrow Size"] = "Arrow Size"
L["Size of the target arrow textures, in pixels."] = "Size of the target arrow textures, in pixels."
L["Arrow Padding"] = "Arrow Padding"
L["Gap between the health bar and the arrows."] = "Gap between the health bar and the arrows."
L["Enable Friendly Player Nameplates"] = "Enable Friendly Player Nameplates"
L["Show friendly player nameplates as name-only with class-colored names (sets nameplateShowFriendlyPlayers, nameplateShowOnlyNameForFriendlyPlayerUnits, and nameplateUseClassColorForFriendlyPlayerUnitNames)."] = "Show friendly player nameplates as name-only with class-colored names (sets nameplateShowFriendlyPlayers, nameplateShowOnlyNameForFriendlyPlayerUnits, and nameplateUseClassColorForFriendlyPlayerUnitNames)."

-- Nameplate Target Resource
L["Target Resource"] = "Target Resource"
L["Enable Target Resource"] = "Enable Target Resource"
L["Show your class resource (combo points, holy power, runes, etc.) under the current target's nameplate instead of the personal plate."] = "Show your class resource (combo points, holy power, runes, etc.) under the current target's nameplate instead of the personal plate."
L["Pixels below the target health bar (negative = further down)."] = "Pixels below the target health bar (negative = further down)."

-- Nameplate Reaction Colors
L["Nameplate Reaction Colors"] = "Nameplate Reaction Colors"
L["Enable Nameplate Reaction Colors"] = "Enable Nameplate Reaction Colors"
L["Tint NPC and mob nameplate health bars with the same darker reaction colors as the target frame. Player nameplates are not changed."] = "Tint NPC and mob nameplate health bars with the same darker reaction colors as the target frame. Player nameplates are not changed."
