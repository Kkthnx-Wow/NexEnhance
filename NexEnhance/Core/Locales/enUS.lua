...
L["Health Bar Text"] = "Health Bar Text"
L["Choose whether the health bar shows current health only or current / max."] = "Choose whether the health bar shows current health only or current / max."
...
L["Enable Loot Frame"] = "Enable Loot Frame"
L["Let the loot window expand to fit more items on one page instead of scrolling."] = "Let the loot window expand to fit more items on one page instead of scrolling."
L["Max Loot Height"] = "Max Loot Height"
L["How tall the loot window may grow, as a percentage of the screen height."] = "How tall the loot window may grow, as a percentage of the screen height."
...
L["Sound While Alt-Tabbed"] = "Sound While Alt-Tabbed"
L["Make the alert sound audible while WoW is minimised or in the background. Briefly overrides your background-sound setting and restores it afterwards."] = "Make the alert sound audible while WoW is minimised or in the background. Briefly overrides your background-sound setting and restores it afterwards."
...
L["Rare Alert Popup"] = "Rare Alert Popup"
L["Show a movable popup when a rare is detected - click it to set a tracked waypoint (uses TomTom if installed). Preview/move it with /nex rare."] = "Show a movable popup when a rare is detected - click it to set a tracked waypoint (uses TomTom if installed). Preview/move it with /nex rare."
L["Click to set a waypoint"] = "Click to set a waypoint"
L["Click to target"] = "Click to target"
L["Click to target & track"] = "Click to target & track"
L["Cannot preview the popup during combat."] = "Cannot preview the popup during combat."
L["Tracking %s."] = "Tracking %s."
L["Toggle rare alert popup preview"] = "Toggle rare alert popup preview"
L["Click To Target"] = "Click To Target"
L["Left-click the popup to clear your target and target the rare by name. Targeting needs a secure click, so it only updates out of combat."] = "Left-click the popup to clear your target and target the rare by name. Targeting needs a secure click, so it only updates out of combat."
L["Raid Marker"] = "Raid Marker"
L["Also place a raid target marker on the rare when you click to target it."] = "Also place a raid target marker on the rare when you click to target it."
L["Off"] = "Off"
L["Star"] = "Star"
L["Circle"] = "Circle"
L["Diamond"] = "Diamond"
...
L["Space or comma separated vignette IDs to never announce."] = "Space or comma separated vignette or NPC IDs to never announce."
...
L["Tint already-known recipes, pets, toys, cosmetics and housing decor green at vendors, the Auction House and Guild Bank (reload to disable)."] = "Tint already-known recipes, pets, toys, cosmetics and housing decor green at vendors, the Auction House and Guild Bank (reload to disable)."
...
L["Area POIs on map %d (%s):"] = "Area POIs on map %d (%s):"
L["POIs"] = "POIs"
L["Events"] = "Events"
L["Quest Hubs"] = "Quest Hubs"
L["Vignettes"] = "Vignettes"
L["None reported - stand in the zone, or pass a map id: /nex poiscan <mapID>"] = "None reported - stand in the zone, or pass a map id: /nex poiscan <mapID>"
...
L["Setup will open when you leave combat."] = "Setup will open when you leave combat."
L["Sorted chat windows: General, Whispers, Trade and Loot."] = "Sorted chat windows: General, Whispers, Trade and Loot."
L["Combat"] = "Combat"
L["Whispers"] = "Whispers"
L["Trade"] = "Trade"
L["Loot"] = "Loot"
